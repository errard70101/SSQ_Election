# -*- coding: utf-8 -*-
"""
Created on Wed Jul 18 13:58:31 2018

@author: Shih-Yang Lins

This script calculates the counterfactual market share when absentee voting
is allowed in all markets and price changes.
"""
...
#data['priced'] = dta['priced'] * 1.5
#data['timed'] = dta['timed'] * 0.5

#adj = 10

#data['priced'] = dta['priced'] + adj * (29.97*1.6/9.7/1000) #avg. fuel price:29.97
#data['timed'] = dta['timed'] + adj * (1.6/40) #avg. speed = 40 km/hr

data['priced'] = dta['price']
data['timed'] = dta['fritime']
...
abs_vot = dta[['mkt', 'priced', 'timed', 'pop_dep', 'moninc', 'edu',
            ...
            'brand', 'marketshare1']].groupby(['mkt']).agg({
               ...
               'const': 'mean', 'xi': 'max', 'census_pop': 'mean', 'brand': 'mean',
               'marketshare1': 'mean'})
